...
image1 = cv2.imread('images/house_face.jpg')
image2 = cv2.imread('images/Trump.jpg')

swapped_1 = swappy(image1, image2)
cv2.imshow('Face Swap 1', swapped_1)

swapped_2 = swappy(image2, image1)
cv2.imshow('Face Swap 2', swapped_2)

cv2.imwrite('Face Swap 1.png', swapped_1)
cv2.imwrite('Face Swap 2.png', swapped_2)
